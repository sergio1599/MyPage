            ...
            <div className={styles.rate}>
                <div className={styles.elements}>
                    <div className={styles.git}>
                        <Link href={"https://github.com/sergio1599"}><a>{gitHub}</a></Link>
                    </div>
                    <div className={styles.instagram}>
                        <Link href={"https://www.instagram.com/s_alejandro_15/"}><a>{instagram}</a></Link>
                    </div>
                    <div className={styles.linkedin}>
                        <Link href={"https://www.linkedin.com/in/sergio-quintana-926566207/"}><a>{linkedin}</a></Link>
                    </div>
                    <div className={styles.twitter}>
                        <Link href={"https://twitter.com/AlejoQ_15"}><a>{twitter}</a></Link>
                    </div>
                    <div className={styles.facebook}>
                        <Link href={"https://www.facebook.com/SergioAlejandro1599/"}><a>{facebook}</a></Link>
                    </div>
                </div>
