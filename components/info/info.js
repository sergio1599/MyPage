        ...
        <div className={styles.info}>
            <div>
                ...
                <p className={styles.font_paragraph}>I'm currently studying Computer Science at the
                    <a href={"http://www.uptc.edu.co/"}> UPTC </a>, I actually  living in <a href={"https://www.google.com/maps/p" +
                    ...
                    video games,
                    whatch series, and codify, I try to lear something new every day</p>
                <p className={styles.font_paragraph}>You can follow me and view my work in GitHub and I have open my <a> Telegram </a>for any questions.</p>
            </div>
